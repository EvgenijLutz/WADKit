...
extension DataReader {
    func read() throws -> MovableIdentifier {
        let rawValue: UInt32 = try read()
        guard let value = MovableIdentifier(rawValue: rawValue) else {
...
class Movable {
    var identifier: MovableIdentifier = .LARA
}
